...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2020 at 12:27 PM
...
(1, 123214521452, 'badravathi', 'Robbery', '2018-12-06', 'My Home has been Robbed.', 'Assigned', 'ChargeSheet Filed', 't104');

-- --------------------------------------------------------

--
-- Table structure for table `criminal_name`
--

CREATE TABLE `criminal_name` (
  `cid` int(11) NOT NULL,
  `name` varchar(200) NOT NULL,
  `description` text NOT NULL,
  `injail` text NOT NULL,
...
INSERT INTO `police` (`p_name`, `p_id`, `spec`, `location`, `p_pass`, `phno`) VALUES
('Manish', 'a101', 'Robbery', 'Anandapur', 'manish', '9176524321'),
('Jaya', 'a102', 'Murder', 'Anandapur', 'jay', '8765432762'),
('raman', 't104', 'All', 'badravathi', 'raman', '8764536278');
...
('shivam@thirthahalli', 'Shivam', 'thirthahalli', 'shivam');
...
INSERT INTO `station_address` (`s_id`, `phno`) VALUES
('shah@anandapur', '876524136'),
('shivam@thirthahalli', '9876543587');
...
--
-- Indexes for table `station_address`
--
ALTER TABLE `station_address`
  ADD PRIMARY KEY (`s_id`,`phno`);
