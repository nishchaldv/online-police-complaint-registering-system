				...
				<?php
					...
					if (isset($_POST['addBtn'])){
						...
						if ($title && $url && $blurb & $keywords){
							...
							mysqli_query($conn, "INSERT INTO criminal_name VALUES ('$id', '$title', '$blurb', '$url', '$keywords')");
							
							// make sure entry was created
							if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM criminal_name WHERE title='{$title}' AND url='{$url}'"))){
